...
import Gambar from "../assets/img-hero.jpg";

const Hero = () => {
  return (
    <div className="w-full h-screen py-16 px-4" id="hero">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        <div className="avatar">
          <div className="sm:w-[450px] mx-auto my-4 mask mask-hexagon">
            <img src={Gambar} alt="/" />
          </div>
        </div>
        <div className="flex flex-col justify-start items-start ">
          ...
          <div className="flex justify-start items-center">
            ...
            <Typed
              className="md:text-5xl sm:text-4xl text-xl text-left font-bold md:pl-4 pl-2 text-[#31E1F7]"
              strings={["Front End Dev", "Flutter Dev", "Android Dev"]}
              typeSpeed={120}
              backSpeed={140}
              loop
            />
          ...
          <button className="bg-[#31E1F7] w-[200px] rounded-md font-medium my-6 py-3 text-black hover:bg-gray-400 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300">
            Curriculum Vitae
          </button>
        </div>
      </div>
